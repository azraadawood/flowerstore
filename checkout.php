...
<head>
    ...
    <link rel="stylesheet" href="style.css"><!-- CSS code link -->
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-6 px-4 pb-4" id="order">
        ...
        <form action="" method="post" id="placeOrder">
          ...
          <div class="form-group">
            <textarea name="address" class="form-control" rows="2" cols="9" placeholder="Enter Delivery Address" required></textarea>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
            <input type="tel" name="card number" class="form-control" placeholder="Enter Card number" required>
          </div>
          <div class="form-group">
            <input type="tel" name="CVV" class="form-control" placeholder="Enter CVV" required>
          </div>
          <div class="form-group">
            <input type="text" name="Expiry date" class="form-control" placeholder="Enter Expiry date of card" required>
          </div>
